...
class Utils {
     ...
     * Note:
     *      Exit code here is set to be 0. This allows auto grader to use
     *      other exit codes as an indication that something blew up.
     * @param message message to print
     */
     static void exitWithError(String message) {
        // TODO: Double check if further modification should be made
     ...
     */
     static void checkNotInitializedError(String arg0){
        if (!arg0.equals("init")) {
    ...
    static void checkNotEmptyString(String str, String message){
         if (str.equals(""))
